...
Si des « Réponses de référence (FAQ) » sont fournies dans le contexte, ce sont des réponses d'autorité : quand la question de l'utilisateur correspond à l'une d'elles, fonde ta réponse dessus et cite leurs sources en priorité, sans la contredire.
