...
const { tools, handlers, reset } = makeDocsTool({
  ...
  searchDescription:
    "Recherche dans la documentation de la communauté beta.gouv.fr (doc.incubateur.net). Utilise get_doc_page pour récupérer le contenu complet d'un résultat. Methodologie, Culture, Processes, Marchés, Services et outils, Standards, Contacts, équipes et personnes référentes de la communauté...",
  pageDescription:
